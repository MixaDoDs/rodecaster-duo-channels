...
- **Громкость музыки для собеседников** не зависит от фейдера USB 1 на пульте:
  звук берётся до фейдера. Её крутят в `pavucontrol`, поток *mix-minus <- музыка (USB 1 Main)*.
